...
app.layout = dbc.Container([
    dbc.Row([
        dbc.Col([
            html.H1("Data pelecehan seksual CICAGO",
                    style={'textAlign': 'center'}),
            html.A(
                "data ini di ambil dari cicago yang di colect dari 2001 - 2022 yang menyertakan 15.0000.0000 data [BURGLARY,THEFT,BATTERY,ASSAULT,NARCOTICS,ROBBERY,PROSTITUTION] yang di tumpuk segingga menampilkan visual melalu kordinat kejadian, sehingga orang-orang bisa menghindari tempat tersebut jika dalam keatan sepi", style={'textAlign': 'center'})
        ], width=12)
    ]),
    dbc.Row([
        dbc.Col([
    ...
    dbc.Row([
        dbc.Col([
            html.H1("The Document Library we use", style={'textAlign': 'center',
                                                          'textSize': '14px'}),
            html.Div([
                dbc.ListGroup(
                    [
